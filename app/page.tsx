...
const translations = {
  'zh-TW': {
    ...
    serviceCards: [
      ...
      {
        title: '簡易 HVAC 服務',
        desc: '空調濾網、溫控器、出風口、冷暖氣基本檢查與簡單維護；複雜維修會先評估再確認。',
  ...
  en: {
    ...
    serviceCards: [
      ...
      {
        title: 'Light HVAC Service',
        desc: 'Air filter, thermostat, vent, and basic heating or cooling checks. Larger repairs are reviewed before scheduling.',
        image: 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&q=80&w=900',
      },
      {
